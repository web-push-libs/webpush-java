...
```groovy
compile group: 'nl.martijndwars', name: 'web-push', version: '4.0.0'
```
...
```
$ java -jar build/libs/web-push-4.0.0-all.jar generate-key
PublicKey:
...
```
$ java -jar build/libs/web-push-4.0.0-all.jar send-notification \
